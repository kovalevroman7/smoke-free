    ...
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal" onClick={e => e.stopPropagation()}>
          ...
          <div className="time-inputs">
            <input
              ...
              onChange={e => {
                ...
                if (val === '' || (parseInt(val, 10) >= 0 && parseInt(val, 10) <= 23)) setAddHours(val)
              }}
            ...
            <input
              ...
              onChange={e => {
                const val = e.target.value.slice(0, 2)
                if (val === '' || (parseInt(val, 10) >= 0 && parseInt(val, 10) <= 59)) setAddMinutes(val)
              }}
        ...
        <div className="modal-buttons">
          ...
          <button className="modal-btn save" onClick={onSave}>Добавить</button>
        </div>
      </div>
    </div>
  )
